              ...
              <div className="p-3">
                ...
                {(isActive || isDone) && task.timeSpent > 0 && (
                  <div className="flex items-center gap-1 mt-2 text-xs text-muted-foreground">
                    {isActive && <Play size={10} className="text-primary animate-pulse" />}
                    <Clock size={10} />
                ...
                {(task.linkedTabIds.length > 0 || task.linkedAppIds.length > 0) && (
                  <div className="flex gap-2 mt-2 text-xs text-muted-foreground">
                    {task.linkedTabIds.length > 0 && <span>{task.linkedTabIds.length} tabs</span>}
                    {task.linkedAppIds.length > 0 && <span>{task.linkedAppIds.length} apps</span>}
                  </div>
                )}
              </div>
            )}
