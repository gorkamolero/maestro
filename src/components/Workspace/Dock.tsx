...
export function Dock() {
  ...
  return (
    <div className="space-y-3">
      {/* Resource Monitor */}
      <div className="bg-background/80 backdrop-blur-xl border border-border/50 rounded-lg px-3 py-2 shadow-lg flex items-center justify-center">
        <ResourcePanel />
      </div>
        ...
        <TooltipProvider delayDuration={0}>
          ...
          {spaces.map((space) => {
            ...
            const hasActiveSegments =
              space.segments.filter((s) => s.status === 'active').length > 0;
